...
case class Longitudinal() extends DerivedStream {
  ...
  private def buildRecord(history: Iterable[Map[String, Any]], schema: Schema): Option[GenericRecord] = {
    ...
    try {
      ...
      JSON2Avro("environment.system",         List[String]("cpu"),              "system_cpu", sorted, root, schema)
      JSON2Avro("environment.system",         List[String]("device"),           "system_device", sorted, root, schema)
      JSON2Avro("environment.system",         List[String]("os"),               "system_os", sorted, root, schema)
      JSON2Avro("environment.system",         List[String]("hdd"),              "system_hdd", sorted, root, schema)
      JSON2Avro("environment.system",         List[String]("gfx"),              "system_gfx", sorted, root, schema)
